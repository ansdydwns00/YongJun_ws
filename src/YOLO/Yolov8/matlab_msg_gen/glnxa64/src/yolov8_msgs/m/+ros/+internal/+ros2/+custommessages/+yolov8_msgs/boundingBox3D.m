...
%BoundingBox3D gives an empty data for yolov8_msgs/BoundingBox3D
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'yolov8_msgs/BoundingBox3D';
...
info.MessageType = 'yolov8_msgs/BoundingBox3D';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
