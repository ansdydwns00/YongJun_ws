...
#include "yolov8_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov8_msgs::msg::Pose2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_msgs::msg::Pose2D & ros_message)
{
  // Member: position
...
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
static size_t _Pose2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Pose2D(full_bounded, is_plain, 0);
...
{
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_msgs, msg, Pose2D)() {
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
