...
#include "yolov8_msgs/msg/detail/key_point3_d__rosidl_typesupport_fastrtps_c.h"
...
using _KeyPoint3D__ros_msg_type = yolov8_msgs__msg__KeyPoint3D;
...
static uint32_t _KeyPoint3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolov8_msgs__msg__KeyPoint3D(
...
static size_t _KeyPoint3D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_yolov8_msgs__msg__KeyPoint3D(
