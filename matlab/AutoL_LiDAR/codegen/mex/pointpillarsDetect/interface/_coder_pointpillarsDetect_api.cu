...
//
// _coder_pointpillarsDetect_api.cu
//
...
static emlrtRTEInfo o_emlrtRTEI{
    1,                               // lineNo
    1,                               // colNo
    "_coder_pointpillarsDetect_api", // fName
    ""                               // pName
};
...
static const mxArray *emlrt_marshallOut(const coder::categorical *u)
{
  ...
  d_y = nullptr;
  iv[0] = 1;
  iv[1] = u->categoryNames.data[0].f1.size[1];
  m6 = emlrtCreateCharArray(2, &iv[0]);
  emlrtInitCharArrayR2013a(emlrtRootTLSGlobal,
                           u->categoryNames.data[0].f1.size[1], m6,
                           &u->categoryNames.data[0].f1.data[0]);
  emlrtAssign(&d_y, m6);
...
{
  static const uint32_T uv1[4]{2502781155U, 4140737229U, 1726905821U,
                               3413689690U};
  static const char_T *sv1[1]{"matFile"};
  emxArray_real32_T *dataInt;
  emxArray_real32_T *dataLoc;
  real_T(*bboxes_data)[964224];
  real_T threshold;
  int32_T bboxes_size[2];
  int32_T iv[1];
  int32_T scores_size[1];
  real32_T(*scores_data)[107136];
  bboxes_data = (real_T(*)[964224])mxMalloc(sizeof(real_T[964224]));
  scores_data = (real32_T(*)[107136])mxMalloc(sizeof(real32_T[107136]));
  ...
  emxInit_real32_T(&dataLoc, 2, &o_emlrtRTEI, true);
  dataLoc->canFreeData = false;
  emlrt_marshallIn(emlrtAlias(prhs[1]), "dataLoc", dataLoc);
  emxInit_real32_T(&dataInt, 1, &o_emlrtRTEI, true);
  ...
  pointpillarsDetect(SD, dataLoc, dataInt, threshold, *bboxes_data, bboxes_size,
...
// End of code generation (_coder_pointpillarsDetect_api.cu)
