...
#include "vision_msgs/msg/detail/detection3_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/detection3_d__functions.h"  // detections
...
using _Detection3DArray__ros_msg_type = vision_msgs__msg__Detection3DArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vision_msgs, msg, Detection3D
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      vision_msgs__msg__Detection3D__Sequence__fini(&ros_message->detections);
    }
    if (!vision_msgs__msg__Detection3D__Sequence__init(&ros_message->detections, size)) {
...
size_t get_serialized_size_vision_msgs__msg__Detection3DArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detection3DArray__ros_msg_type * ros_message = static_cast<const _Detection3DArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vision_msgs__msg__Detection3D(
...
static uint32_t _Detection3DArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__Detection3DArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t max_serialized_size_vision_msgs__msg__Detection3DArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_vision_msgs__msg__Detection3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Detection3DArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__Detection3DArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msgs, msg, Detection3DArray)() {
