...
#include "vision_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/point2_d__functions.h"  // position
...
using _Pose2D__ros_msg_type = vision_msgs__msg__Pose2D;
...
size_t get_serialized_size_vision_msgs__msg__Pose2D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pose2D__ros_msg_type * ros_message = static_cast<const _Pose2D__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Pose2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__Pose2D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_msgs
size_t max_serialized_size_vision_msgs__msg__Pose2D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Pose2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__Pose2D(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msgs, msg, Pose2D)() {
