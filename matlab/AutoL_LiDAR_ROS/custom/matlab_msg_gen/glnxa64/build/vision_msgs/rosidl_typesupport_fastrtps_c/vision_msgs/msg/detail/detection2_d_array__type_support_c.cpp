...
#include "vision_msgs/msg/detail/detection2_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/detection2_d__functions.h"  // detections
...
using _Detection2DArray__ros_msg_type = vision_msgs__msg__Detection2DArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vision_msgs, msg, Detection2D
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _Detection2DArray__ros_msg_type * ros_message = static_cast<_Detection2DArray__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: detections
  {
    ...
    if (ros_message->detections.data) {
      vision_msgs__msg__Detection2D__Sequence__fini(&ros_message->detections);
    }
    if (!vision_msgs__msg__Detection2D__Sequence__init(&ros_message->detections, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vision_msgs__msg__Detection2D(
...
static uint32_t _Detection2DArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__Detection2DArray(
  ...
  size_t current_alignment)
{
  ...
  // member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_vision_msgs__msg__Detection2D(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Detection2DArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__Detection2DArray(
