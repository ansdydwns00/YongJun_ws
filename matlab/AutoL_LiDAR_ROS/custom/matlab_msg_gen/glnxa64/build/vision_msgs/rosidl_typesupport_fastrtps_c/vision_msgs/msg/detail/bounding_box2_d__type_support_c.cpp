...
#include "vision_msgs/msg/detail/pose2_d__functions.h"  // center
  ...
  // Field name: center
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, vision_msgs, msg, Pose2D
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_vision_msgs__msg__Pose2D(
  ...
  size_t current_alignment)
{
  ...
  // member: center
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_vision_msgs__msg__Pose2D(
