...
#include "vision_msgs/msg/detail/vision_class__rosidl_typesupport_fastrtps_c.h"
...
using _VisionClass__ros_msg_type = vision_msgs__msg__VisionClass;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VisionClass__ros_msg_type * ros_message = static_cast<const _VisionClass__ros_msg_type *>(untyped_ros_message);
  // Field name: class_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VisionClass__ros_msg_type * ros_message = static_cast<_VisionClass__ros_msg_type *>(untyped_ros_message);
  // Field name: class_id
  {
    cdr >> ros_message->class_id;
  }
...
static uint32_t _VisionClass__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__VisionClass(
...
static size_t _VisionClass__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__VisionClass(
...
static message_type_support_callbacks_t __callbacks_VisionClass = {
  "vision_msgs::msg",
  "VisionClass",
...
static rosidl_message_type_support_t _VisionClass__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VisionClass,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_msgs, msg, VisionClass)() {
  return &_VisionClass__type_support;
}
