...
#include "vision_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const vision_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, Pose2D)() {
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
