...
{
  new (message_memory) vision_msgs::msg::Pose2D(_init);
}

void Pose2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vision_msgs::msg::Pose2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose2D_message_member_array[2] = {
  {
    ...
    offsetof(vision_msgs::msg::Pose2D, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vision_msgs::msg::Pose2D, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<vision_msgs::msg::Pose2D>()
{
  return &::vision_msgs::msg::rosidl_typesupport_introspection_cpp::Pose2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_msgs, msg, Pose2D)() {
  return &::vision_msgs::msg::rosidl_typesupport_introspection_cpp::Pose2D_message_type_support_handle;
}
