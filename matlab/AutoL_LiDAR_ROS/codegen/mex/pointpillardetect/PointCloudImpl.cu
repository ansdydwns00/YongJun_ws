    ...
    emxArray_real32_T *gpu_outRangeData, boolean_T *outRangeData_outdatedOnGpu)
{
  ...
  emxInit_real_T(&cpu_outIndex, 1, &ab_emlrtRTEI, true);
  if ((cpu_location->size[0] == 0) || (cpu_indices->size[0] == 0)) {
    *outLoc_outdatedOnCpu = false;
    ...
    emxEnsureCapacity_real_T(cpu_outIndex, i, &ab_emlrtRTEI);
    ...
    cpu_outLoc->size[1] = 3;
    emxEnsureCapacity_real32_T(cpu_outLoc, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
  ...
  emxInit_real_T(&b_cpu_outIndex, 1, &ab_emlrtRTEI, true);
  if ((cpu_color->size[0] == 0) || (cpu_color->size[1] == 0) ||
    ...
    *outCol_outdatedOnCpu = false;
    ...
    emxEnsureCapacity_real_T(b_cpu_outIndex, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    ...
    cpu_outCol->size[1] = 3;
    emxEnsureCapacity_uint8_T(cpu_outCol, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(2, i), &grid, &block, 2147483647U);
  ...
  emxInit_real_T(&c_cpu_outIndex, 1, &ab_emlrtRTEI, true);
  if ((cpu_normal->size[0] == 0) || (cpu_normal->size[1] == 0) ||
    ...
    *outNorm_outdatedOnCpu = false;
    ...
    emxEnsureCapacity_real_T(c_cpu_outIndex, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    if (indices_needsGpuEnsureCapacity) {
      gpuEmxEnsureCapacity_boolean_T(cpu_indices, gpu_indices,
    ...
    cpu_outNorm->size[1] = 3;
    emxEnsureCapacity_real32_T(cpu_outNorm, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(2, i), &grid, &block, 2147483647U);
  ...
  emxInit_real_T(&d_cpu_outIndex, 1, &ab_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_outIntensity, 1, &ab_emlrtRTEI, true);
  if ((cpu_intensity->size[0] == 0) || (cpu_indices->size[0] == 0)) {
    ...
    emxEnsureCapacity_real_T(d_cpu_outIndex, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    if (indices_needsGpuEnsureCapacity) {
      gpuEmxEnsureCapacity_boolean_T(cpu_indices, gpu_indices,
    ...
    emxEnsureCapacity_real32_T(b_cpu_outIntensity, i, &ab_emlrtRTEI);
  ...
  emxEnsureCapacity_real32_T(cpu_outIntensity, i, &ab_emlrtRTEI);
  ...
  emxInit_real_T(&e_cpu_outIndex, 1, &ab_emlrtRTEI, true);
  if ((cpu_rangeData->size[0] == 0) || (cpu_rangeData->size[1] == 0) ||
    ...
    *outRangeData_outdatedOnCpu = false;
    ...
    emxEnsureCapacity_real_T(e_cpu_outIndex, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    if (indices_needsGpuEnsureCapacity) {
      gpuEmxEnsureCapacity_boolean_T(cpu_indices, gpu_indices,
    ...
    cpu_outRangeData->size[1] = 3;
    emxEnsureCapacity_real32_T(cpu_outRangeData, i, &ab_emlrtRTEI);
    i = cpu_indices->size[0] - 1;
    mwGetLaunchParameters1D(computeNumIters(2, i), &grid, &block, 2147483647U);
                                     ...
                                     boolean_T *validCoords_outdatedOnGpu)
{
  ...
  emxEnsureCapacity_boolean_T(cpu_validCoords, i, &y_emlrtRTEI);
