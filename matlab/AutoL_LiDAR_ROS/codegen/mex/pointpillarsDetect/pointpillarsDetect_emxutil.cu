...
//
// pointpillarsDetect_emxutil.cu
//
// Code generation for function 'pointpillarsDetect_emxutil'
//
...
{
  pStruct->AnchorsBEV.size[0] = 0;
  pStruct->AnchorsBEV.size[1] = 0;
}
...
// End of code generation (pointpillarsDetect_emxutil.cu)
