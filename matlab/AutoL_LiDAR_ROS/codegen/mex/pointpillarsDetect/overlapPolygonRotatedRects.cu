                                     ...
                                     int32_T overlapPoly_size[2])
{
  ...
  distVec_size_idx_1 = overlapedPolyPts_size[1];
  ...
  for (int32_T k{0}; k < distVec_size_idx_1; k++) {
  ...
  distVec_size_idx_1 = iidx_size[1];
  vlen = iidx_size[1];
  ...
  for (xoffset = 0; xoffset < (distVec_size_idx_1 << 1); xoffset++) {
