 ...
 *
 * _coder_preprocessing_api.c
 *
 * Code generation for function '_coder_preprocessing_api'
 *
 */
...
static emlrtRTEInfo wc_emlrtRTEI = {
    1,                          /* lineNo */
    1,                          /* colNo */
    "_coder_preprocessing_api", /* fName */
    ""                          /* pName */
};
...
void preprocessing_api(preprocessingStackData *SD, const mxArray *const prhs[6],
                       int32_T nlhs, const mxArray *plhs[2])
{
  ...
  emxInit_real32_T(&st, &Points, 2, &wc_emlrtRTEI);
  emxInit_real32_T(&st, &Intensity, 1, &wc_emlrtRTEI);
  preprocessing(SD, &st, SD->f1.points, SD->f1.intensity, ROI,
...
/* End of code generation (_coder_preprocessing_api.c) */
