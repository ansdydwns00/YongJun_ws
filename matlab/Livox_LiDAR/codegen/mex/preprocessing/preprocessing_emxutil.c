 ...
 *
 * preprocessing_emxutil.c
 *
 * Code generation for function 'preprocessing_emxutil'
 *
 */
                                ...
                                const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)i * sizeof(uint16_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data, sizeof(uint16_T) * (uint32_T)oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex(emxArray->data);
      }
    }
                              ...
                              const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_real32_T(sp, &pStruct->Intensity, 1, srcLocation);
                      ...
                      const emlrtRTEInfo *srcLocation)
{
  ...
  *pEmxArray =
      (emxArray_uint16_T *)emlrtMallocEmxArray(sizeof(emxArray_uint16_T));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
  }
  emlrtPushHeapReferenceStackEmxArray((emlrtCTX)sp, true, (void *)pEmxArray,
...
/* End of code generation (preprocessing_emxutil.c) */
