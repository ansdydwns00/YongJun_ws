...
/* Include files */
#include "_coder_preprocessing2_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("preprocessing2"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739429.56383101852));
...
/* End of code generation (_coder_preprocessing2_info.c) */
