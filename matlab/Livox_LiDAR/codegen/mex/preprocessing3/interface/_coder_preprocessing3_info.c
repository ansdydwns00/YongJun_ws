...
/* Include files */
#include "_coder_preprocessing3_info.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("preprocessing3"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739429.60769675928));
...
/* End of code generation (_coder_preprocessing3_info.c) */
