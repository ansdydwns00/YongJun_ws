...
SRCS = $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_data.c $(START_DIR)/codegen/lib/Avia_parsing_single/rt_nonfinite.c $(START_DIR)/codegen/lib/Avia_parsing_single/rtGetNaN.c $(START_DIR)/codegen/lib/Avia_parsing_single/rtGetInf.c $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_initialize.c $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_terminate.c $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single.c $(START_DIR)/codegen/lib/Avia_parsing_single/colon.c $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_emxutil.c $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_emxAPI.c
...
OBJS = Avia_parsing_single_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o Avia_parsing_single_initialize.o Avia_parsing_single_terminate.o Avia_parsing_single.o colon.o Avia_parsing_single_emxutil.o Avia_parsing_single_emxAPI.o
...
%.o : $(START_DIR)/codegen/lib/Avia_parsing_single/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/Avia_parsing_single/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Avia_parsing_single_data.o : $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/codegen/lib/Avia_parsing_single/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/Avia_parsing_single/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/Avia_parsing_single/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Avia_parsing_single_initialize.o : $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Avia_parsing_single_terminate.o : $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Avia_parsing_single.o : $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single.c
	$(CC) $(CFLAGS) -o "$@" "$<"


colon.o : $(START_DIR)/codegen/lib/Avia_parsing_single/colon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Avia_parsing_single_emxutil.o : $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Avia_parsing_single_emxAPI.o : $(START_DIR)/codegen/lib/Avia_parsing_single/Avia_parsing_single_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
