 ...
 * File: _coder_preprocessing_api.c
 *
                       ...
                       const mxArray *plhs[2])
{
  ...
  preprocessing(points, intensity, ROI, GroundMaxDistance,
...
void preprocessing_atexit(void)
{
  ...
  preprocessing_xil_terminate();
  preprocessing_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_preprocessing_api.c
 *
 * [EOF]
 */
