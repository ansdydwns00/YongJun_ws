...
#include "preprocessing_emxAPI.h"
...
void main_preprocessing(void)
{
  ...
  /* Initialize function 'preprocessing' input arguments. */
  ...
  /* Call the entry-point 'preprocessing'. */
  ...
  preprocessing(fv, fv1, fv2, GroundMaxDistance_tmp, fv3, GroundMaxDistance_tmp,
                Points, Intensity);
