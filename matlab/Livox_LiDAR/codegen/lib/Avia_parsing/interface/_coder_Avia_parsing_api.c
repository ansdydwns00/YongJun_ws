                      ...
                      const mxArray *plhs[2])
{
  ...
  Avia_parsing(packet, reset_flag, xyzCoords, &isValid);
...
void Avia_parsing_atexit(void)
{
  ...
  Avia_parsing_xil_terminate();
  Avia_parsing_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_Avia_parsing_api.c
 *
 * [EOF]
 */
