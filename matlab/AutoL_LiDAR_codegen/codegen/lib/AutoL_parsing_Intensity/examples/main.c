...
#include "AutoL_parsing_Intensity_emxAPI.h"
#include "AutoL_parsing_Intensity_terminate.h"
 ...
 * Return Type  : void
 */
void main_AutoL_parsing_Intensity(void)
{
  emxArray_real32_T *xyzCoords;
  emxArray_real32_T *xyzIntensity;
  float fv[1330];
  boolean_T isValid;
  /* Initialize function 'AutoL_parsing_Intensity' input arguments. */
  /* Initialize function input argument 'packetData'. */
  /* Call the entry-point 'AutoL_parsing_Intensity'. */
  emxInitArray_real32_T(&xyzCoords, 2);
  emxInitArray_real32_T(&xyzIntensity, 2);
  argInit_1330x1_real32_T(fv);
  AutoL_parsing_Intensity(fv, argInit_real32_T(), xyzCoords, xyzIntensity,
                          &isValid);
