...
/* Include Files */
#include "main.h"
#include "AutoL_parsing_vector.h"
#include "AutoL_parsing_vector_emxAPI.h"
#include "AutoL_parsing_vector_terminate.h"
 ...
 * Return Type  : void
 */
void main_AutoL_parsing_vector(void)
{
  emxArray_real32_T *xyzCoords;
  float fv[1330];
  bool isValid;
  /* Initialize function 'AutoL_parsing_vector' input arguments. */
  /* Initialize function input argument 'packetData'. */
  /* Call the entry-point 'AutoL_parsing_vector'. */
  emxInitArray_real32_T(&xyzCoords, 2);
  argInit_1330x1_real32_T(fv);
  AutoL_parsing_vector(fv, argInit_real32_T(), xyzCoords, &isValid);
