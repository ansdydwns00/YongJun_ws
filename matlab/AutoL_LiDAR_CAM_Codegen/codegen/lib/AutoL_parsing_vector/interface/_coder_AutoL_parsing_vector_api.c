 ...
 * File: _coder_AutoL_parsing_vector_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "AutoL_parsing_vector",                               /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
                              ...
                              const mxArray *plhs[2])
{
  ...
  AutoL_parsing_vector(packetData, reset_flag, xyzCoords, &isValid);
...
void AutoL_parsing_vector_atexit(void)
{
  ...
  AutoL_parsing_vector_xil_terminate();
  AutoL_parsing_vector_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_AutoL_parsing_vector_api.c
 *
 * [EOF]
 */
