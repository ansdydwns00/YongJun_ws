...
#include "AutoL_parsing_vector_arm_emxAPI.h"
#include "AutoL_parsing_vector_arm_terminate.h"
 ...
 * Return Type  : void
 */
void main_AutoL_parsing_vector_arm(void)
{
  emxArray_real32_T *xyzCoords;
  float fv[1330];
  bool isValid;
  /* Initialize function 'AutoL_parsing_vector_arm' input arguments. */
  /* Initialize function input argument 'packetData'. */
  /* Call the entry-point 'AutoL_parsing_vector_arm'. */
  emxInitArray_real32_T(&xyzCoords, 2);
  argInit_1330x1_real32_T(fv);
  AutoL_parsing_vector_arm(fv, argInit_real32_T(), xyzCoords, &isValid);
