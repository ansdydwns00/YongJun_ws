 ...
 * File: _coder_AutoL_parsing_vector_arm_api.c
 *
...
/* Include Files */
#include "_coder_AutoL_parsing_vector_arm_api.h"
#include "_coder_AutoL_parsing_vector_arm_mex.h"
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "AutoL_parsing_vector_arm",                           /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
 ...
 * Return Type  : void
 */
void AutoL_parsing_vector_arm_api(const mxArray *const prhs[2], int32_T nlhs,
                                  const mxArray *plhs[2])
{
  emlrtStack st = {
      NULL, /* site */
  ...
  AutoL_parsing_vector_arm(packetData, reset_flag, xyzCoords, &isValid);
 ...
 * Return Type  : void
 */
void AutoL_parsing_vector_arm_atexit(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  AutoL_parsing_vector_arm_xil_terminate();
  AutoL_parsing_vector_arm_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
 ...
 * Return Type  : void
 */
void AutoL_parsing_vector_arm_initialize(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
 ...
 * Return Type  : void
 */
void AutoL_parsing_vector_arm_terminate(void)
{
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

/*
 * File trailer for _coder_AutoL_parsing_vector_arm_api.c
 *
 * [EOF]
 */
