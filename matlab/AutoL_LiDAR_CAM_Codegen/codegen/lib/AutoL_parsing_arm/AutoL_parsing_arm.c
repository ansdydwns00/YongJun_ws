 ...
 * Return Type  : void
 */
void AutoL_parsing_arm(const float packetData[1330], float reset_flag,
                       emxArray_real32_T *xyzCoords, bool *isValid)
{
  ...
  bool guard1;
  if (!isInitialized_AutoL_parsing_arm) {
    AutoL_parsing_arm_initialize();
  }
 ...
 * Return Type  : void
 */
void AutoL_parsing_arm_init(void)
{
  points_not_empty = false;
}

/*
 * File trailer for AutoL_parsing_arm.c
 *
 * [EOF]
 */
