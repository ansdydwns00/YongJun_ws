 ...
 * File: _coder_AutoL_parsing_arm_api.c
 *
...
/* Include Files */
#include "_coder_AutoL_parsing_arm_api.h"
#include "_coder_AutoL_parsing_arm_mex.h"
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "AutoL_parsing_arm",                                  /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
                           ...
                           const mxArray *plhs[2])
{
  ...
  AutoL_parsing_arm(packetData, reset_flag, xyzCoords, &isValid);
...
void AutoL_parsing_arm_atexit(void)
{
  ...
  AutoL_parsing_arm_xil_terminate();
  AutoL_parsing_arm_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_AutoL_parsing_arm_api.c
 *
 * [EOF]
 */
