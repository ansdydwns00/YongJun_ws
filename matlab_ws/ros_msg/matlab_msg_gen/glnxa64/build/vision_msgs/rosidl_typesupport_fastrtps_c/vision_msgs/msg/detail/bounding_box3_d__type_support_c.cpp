...
#include "vision_msgs/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox3D__ros_msg_type = vision_msgs__msg__BoundingBox3D;
...
static uint32_t _BoundingBox3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_msgs__msg__BoundingBox3D(
...
static size_t _BoundingBox3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_msgs__msg__BoundingBox3D(
