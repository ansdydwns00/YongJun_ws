...
#include "vision_msgs/msg/detail/vision_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vision_msgs
max_serialized_size_VisionInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const vision_msgs::msg::VisionInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_msgs::msg::VisionInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VisionInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vision_msgs::msg::VisionInfo *>(
...
static size_t _VisionInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VisionInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VisionInfo__callbacks = {
  "vision_msgs::msg",
  "VisionInfo",
...
static rosidl_message_type_support_t _VisionInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VisionInfo__callbacks,
...
{
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_VisionInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_msgs, msg, VisionInfo)() {
  return &vision_msgs::msg::typesupport_fastrtps_cpp::_VisionInfo__handle;
}
