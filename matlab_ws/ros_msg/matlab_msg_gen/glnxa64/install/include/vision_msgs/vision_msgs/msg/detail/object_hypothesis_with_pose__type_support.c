...
void vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_init_function(
...
void vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_message_members = {
  ...
  vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_message_type_support_handle = {
  0,
  &vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_msgs, msg, ObjectHypothesisWithPose)() {
  ...
  return &vision_msgs__msg__ObjectHypothesisWithPose__rosidl_typesupport_introspection_c__ObjectHypothesisWithPose_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
