...
{
  const auto & item = *reinterpret_cast<const vision_msgs::msg::Detection2D *>(
    get_const_function__Detection2DArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<vision_msgs::msg::Detection2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<vision_msgs::msg::Detection2D *>(
    get_function__Detection2DArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const vision_msgs::msg::Detection2D *>(untyped_value);
  item = value;
}
