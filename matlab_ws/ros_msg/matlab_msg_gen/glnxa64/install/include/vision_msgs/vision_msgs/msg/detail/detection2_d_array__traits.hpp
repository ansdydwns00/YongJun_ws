...
#ifndef VISION_MSGS__MSG__DETAIL__DETECTION2_D_ARRAY__TRAITS_HPP_
#define VISION_MSGS__MSG__DETAIL__DETECTION2_D_ARRAY__TRAITS_HPP_
...
inline std::string to_yaml(const vision_msgs::msg::Detection2DArray & msg)
{
  return vision_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<vision_msgs::msg::Detection2DArray>()
{
  return "vision_msgs::msg::Detection2DArray";
}

template<>
inline const char * name<vision_msgs::msg::Detection2DArray>()
{
  return "vision_msgs/msg/Detection2DArray";
}

template<>
struct has_fixed_size<vision_msgs::msg::Detection2DArray>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<vision_msgs::msg::Detection2DArray>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<vision_msgs::msg::Detection2DArray>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // VISION_MSGS__MSG__DETAIL__DETECTION2_D_ARRAY__TRAITS_HPP_
