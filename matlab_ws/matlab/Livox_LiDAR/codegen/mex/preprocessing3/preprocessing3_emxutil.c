                              ...
                              const emlrtRTEInfo *srcLocation)
{
  ...
  emxInit_uint8_T(sp, &pStruct->Color, 2, srcLocation);
...
void emxInitStruct_pointCloud1(const emlrtStack *sp, b_pointCloud *pStruct,
                               const emlrtRTEInfo *srcLocation)
{
  emxInit_uint8_T(sp, &pStruct->Color, 3, srcLocation);
  emxInit_real32_T(sp, &pStruct->Normal, 3, srcLocation);
  emxInit_real32_T(sp, &pStruct->Intensity, 2, srcLocation);
  emxInit_real32_T(sp, &pStruct->RangeData, 3, srcLocation);
...
/* End of code generation (preprocessing3_emxutil.c) */
