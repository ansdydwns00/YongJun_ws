...
#ifndef typedef_b_preprocessing2
#define typedef_b_preprocessing2
typedef struct {
  b_pointCloud ptCloud_tmp;
} b_preprocessing2;
#endif /* typedef_b_preprocessing2 */

#ifndef typedef_b_preprocessing2_api
#define typedef_b_preprocessing2_api
typedef struct {
  real32_T points[172800];
  real32_T intensity[57600];
} b_preprocessing2_api;
#endif /* typedef_b_preprocessing2_api */

#ifndef typedef_preprocessing2StackData
#define typedef_preprocessing2StackData
typedef struct {
  b_preprocessing2 f0;
  b_preprocessing2_api f1;
} preprocessing2StackData;
#endif /* typedef_preprocessing2StackData */

/* End of code generation (preprocessing2_types.h) */
