 ...
 * File: _coder_preprocessing3_mex.c
 *
                 ...
                 const mxArray *prhs[])
{
  ...
  unsafe_preprocessing3_mexFunction(nlhs, plhs, nrhs, prhs);
  /* Module termination. */
                                       ...
                                       int32_T nrhs, const mxArray *prhs[2])
{
  ...
  b_prhs[0] = prhs[0];
  b_prhs[1] = prhs[1];
  preprocessing3_api(b_prhs, nlhs, outputs);
...
/*
 * File trailer for _coder_preprocessing3_mex.c
 *
 * [EOF]
 */
