...
void emxInitStruct_pointCloud(pointCloud *pStruct)
{
  ...
  emxInit_uint8_T(&pStruct->Color, 2);
  emxInit_real32_T(&pStruct->Normal, 2);
  emxInit_real32_T(&pStruct->Intensity, 2);
}
...
{
  emxInit_uint8_T(&pStruct->Color, 3);
  emxInit_real32_T(&pStruct->Normal, 3);
  emxInit_real32_T(&pStruct->Intensity, 2);
  emxInit_real32_T(&pStruct->RangeData, 3);
...
/*
 * File trailer for preprocessing3_emxutil.c
 *
 * [EOF]
 */
