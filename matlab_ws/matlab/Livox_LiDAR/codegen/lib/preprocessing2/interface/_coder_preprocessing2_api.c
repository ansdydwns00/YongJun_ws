 ...
 * File: _coder_preprocessing2_api.c
 *
                        ...
                        const mxArray *plhs[2])
{
  ...
  emxInit_real32_T(&st, &Points, 2);
  emxInit_real32_T(&st, &Intensity, 1);
  preprocessing2(points, intensity, ROI, GroundMaxDistance,
                 GroundReferenceVector, GroundMaxAngularDistance, Points,
                 Intensity);
...
void preprocessing2_atexit(void)
{
  ...
  preprocessing2_xil_terminate();
  preprocessing2_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_preprocessing2_api.c
 *
 * [EOF]
 */
