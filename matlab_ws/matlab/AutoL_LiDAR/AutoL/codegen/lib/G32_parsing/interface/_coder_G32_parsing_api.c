                     ...
                     const mxArray *plhs[3])
{
  ...
  G32_parsing(packetData, reset_flag, xyzCoords, xyzIntensity, &isValid);
...
void G32_parsing_atexit(void)
{
  ...
  G32_parsing_xil_terminate();
  G32_parsing_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/*
 * File trailer for _coder_G32_parsing_api.c
 *
 * [EOF]
 */
