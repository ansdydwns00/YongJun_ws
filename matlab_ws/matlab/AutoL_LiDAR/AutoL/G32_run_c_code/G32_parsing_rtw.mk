###########################################################################
## Makefile generated for component 'G32_parsing'. 
## 
## Makefile     : G32_parsing_rtw.mk
## Generated on : Mon Jul 29 11:53:44 2024
## Final product: ./G32_parsing.lib
...
PRODUCT_NAME              = G32_parsing
MAKEFILE                  = G32_parsing_rtw.mk
MATLAB_ROOT               = /usr/local/MATLAB/R2024a
MATLAB_BIN                = /usr/local/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/glnxa64
START_DIR                 = /home/aiv/YongJun_ws/matlab_ws/matlab/AutoL_LiDAR/AutoL_LiDAR_CAM_Codegen/AutoL
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = G32_parsing_rtw_comp.rsp
CMD_FILE                  = G32_parsing_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = G32_parsing.lib
...
DEFINES_STANDARD = -DMODEL=G32_parsing
...
SRCS = $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_data.c $(START_DIR)/codegen/lib/G32_parsing/rt_nonfinite.c $(START_DIR)/codegen/lib/G32_parsing/rtGetNaN.c $(START_DIR)/codegen/lib/G32_parsing/rtGetInf.c $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_initialize.c $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_terminate.c $(START_DIR)/codegen/lib/G32_parsing/G32_parsing.c $(START_DIR)/codegen/lib/G32_parsing/colon.c $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_emxutil.c $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_emxAPI.c
...
OBJS = G32_parsing_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o G32_parsing_initialize.o G32_parsing_terminate.o G32_parsing.o colon.o G32_parsing_emxutil.o G32_parsing_emxAPI.o
...
%.o : $(START_DIR)/codegen/lib/G32_parsing/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/G32_parsing/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/G32_parsing/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/G32_parsing/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/G32_parsing/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
G32_parsing_data.o : $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/codegen/lib/G32_parsing/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/G32_parsing/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/G32_parsing/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


G32_parsing_initialize.o : $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


G32_parsing_terminate.o : $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


G32_parsing.o : $(START_DIR)/codegen/lib/G32_parsing/G32_parsing.c
	$(CC) $(CFLAGS) -o "$@" "$<"


colon.o : $(START_DIR)/codegen/lib/G32_parsing/colon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


G32_parsing_emxutil.o : $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


G32_parsing_emxAPI.o : $(START_DIR)/codegen/lib/G32_parsing/G32_parsing_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
