...
## Generated on : Sun Jun 30 15:09:05 2024
## Final product: ./Avia_parsing.lib
...
COMPILER_COMMAND_FILE     = Avia_parsing_rtw_comp.rsp
CMD_FILE                  = Avia_parsing_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Avia_parsing.lib
...
%.o : $(START_DIR)/codegen/lib/Avia_parsing/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
