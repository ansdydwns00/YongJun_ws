function frustumIndices = HelperBboxCameraToLidar_TF(bboxesCamera, ptCloudIn, intrinsics, tform, varargin)
...
for bboxesCount = 1:numBboxes
    ...
    frustumIndices{bboxesCount} = lidar.internal.findPointsInFrustum(bboxLidar, pts);
end
end
