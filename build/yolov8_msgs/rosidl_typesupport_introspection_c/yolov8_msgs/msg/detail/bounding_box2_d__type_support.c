...
// Member `center`
#include "yolov8_msgs/msg/pose2_d.h"
// Member `center`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  yolov8_msgs__msg__BoundingBox2D__init(message_memory);
}

void BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_fini_function(void * message_memory)
{
  yolov8_msgs__msg__BoundingBox2D__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_message_member_array[2] = {
  {
    ...
    offsetof(yolov8_msgs__msg__BoundingBox2D, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs__msg__BoundingBox2D, size),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers BoundingBox2D__rosidl_typesupport_introspection_c__BoundingBox2D_message_members = {
  ...
  2,  // number of fields
  sizeof(yolov8_msgs__msg__BoundingBox2D),
