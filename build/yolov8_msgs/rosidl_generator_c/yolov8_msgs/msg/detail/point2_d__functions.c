...
yolov8_msgs__msg__Point2D__create()
{
  ...
  yolov8_msgs__msg__Point2D * msg = (yolov8_msgs__msg__Point2D *)allocator.allocate(sizeof(yolov8_msgs__msg__Point2D), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yolov8_msgs__msg__Point2D));
  bool success = yolov8_msgs__msg__Point2D__init(msg);
  if (!success) {
...
yolov8_msgs__msg__Point2D__destroy(yolov8_msgs__msg__Point2D * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    yolov8_msgs__msg__Point2D__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
yolov8_msgs__msg__Point2D__Sequence__init(yolov8_msgs__msg__Point2D__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolov8_msgs__msg__Point2D * data = NULL;

  if (size) {
    data = (yolov8_msgs__msg__Point2D *)allocator.zero_allocate(size, sizeof(yolov8_msgs__msg__Point2D), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yolov8_msgs__msg__Point2D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        yolov8_msgs__msg__Point2D__fini(&data[i - 1]);
      }
...
yolov8_msgs__msg__Point2D__Sequence__fini(yolov8_msgs__msg__Point2D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      yolov8_msgs__msg__Point2D__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yolov8_msgs__msg__Point2D__Sequence * array = (yolov8_msgs__msg__Point2D__Sequence *)allocator.allocate(sizeof(yolov8_msgs__msg__Point2D__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yolov8_msgs__msg__Point2D__Sequence__init(array, size);
  if (!success) {
...
yolov8_msgs__msg__Point2D__Sequence__destroy(yolov8_msgs__msg__Point2D__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yolov8_msgs__msg__Point2D__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yolov8_msgs__msg__Point2D__Sequence__are_equal(const yolov8_msgs__msg__Point2D__Sequence * lhs, const yolov8_msgs__msg__Point2D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yolov8_msgs__msg__Point2D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yolov8_msgs__msg__Point2D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(yolov8_msgs__msg__Point2D);
    yolov8_msgs__msg__Point2D * data =
      (yolov8_msgs__msg__Point2D *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yolov8_msgs__msg__Point2D__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          yolov8_msgs__msg__Point2D__fini(&data[i]);
        }
        free(data);
        return false;
      }
