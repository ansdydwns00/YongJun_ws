...
class KeyPoint2DArray(metaclass=Metaclass_KeyPoint2DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<yolov8_msgs/KeyPoint2D>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['yolov8_msgs', 'msg'], 'KeyPoint2D')),  # noqa: E501
    )
