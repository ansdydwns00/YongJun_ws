...
{
  new (message_memory) yolov8_msgs::msg::KeyPoint3D(_init);
}

void KeyPoint3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov8_msgs::msg::KeyPoint3D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyPoint3D_message_member_array[3] = {
  {
    ...
    offsetof(yolov8_msgs::msg::KeyPoint3D, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs::msg::KeyPoint3D, point),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs::msg::KeyPoint3D, score),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyPoint3D_message_members = {
  ...
  3,  // number of fields
  sizeof(yolov8_msgs::msg::KeyPoint3D),
...
{
  return &::yolov8_msgs::msg::rosidl_typesupport_introspection_cpp::KeyPoint3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_msgs, msg, KeyPoint3D)() {
  return &::yolov8_msgs::msg::rosidl_typesupport_introspection_cpp::KeyPoint3D_message_type_support_handle;
}
