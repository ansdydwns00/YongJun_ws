...
{
  new (message_memory) yolov8_msgs::msg::Vector2(_init);
}

void Vector2_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yolov8_msgs::msg::Vector2 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Vector2_message_member_array[2] = {
  {
    ...
    offsetof(yolov8_msgs::msg::Vector2, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yolov8_msgs::msg::Vector2, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Vector2_message_members = {
  ...
  2,  // number of fields
  sizeof(yolov8_msgs::msg::Vector2),
...
{
  return &::yolov8_msgs::msg::rosidl_typesupport_introspection_cpp::Vector2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_msgs, msg, Vector2)() {
  return &::yolov8_msgs::msg::rosidl_typesupport_introspection_cpp::Vector2_message_type_support_handle;
}
