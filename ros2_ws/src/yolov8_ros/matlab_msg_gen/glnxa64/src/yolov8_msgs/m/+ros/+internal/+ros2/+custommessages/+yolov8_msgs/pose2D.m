...
%Pose2D gives an empty data for yolov8_msgs/Pose2D
% Copyright 2019-2021 The MathWorks, Inc.
data = struct();
data.MessageType = 'yolov8_msgs/Pose2D';
[data.position, info.position] = ros.internal.ros2.custommessages.yolov8_msgs.point2D;
info.position.MLdataType = 'struct';
[data.theta, info.theta] = ros.internal.ros2.messages.ros2.default_type('double',1,0);
info.MessageType = 'yolov8_msgs/Pose2D';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;
