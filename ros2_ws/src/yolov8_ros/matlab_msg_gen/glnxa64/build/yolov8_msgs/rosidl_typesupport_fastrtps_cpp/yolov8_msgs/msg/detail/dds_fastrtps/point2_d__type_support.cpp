...
#include "yolov8_msgs/msg/detail/point2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::Point2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_msgs::msg::Point2D *>(
    untyped_ros_message);
...
{
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
