...
#include "yolov8_msgs/msg/detail/mask__rosidl_typesupport_fastrtps_c.h"
...
#include "yolov8_msgs/msg/detail/point2_d__functions.h"  // data
...
using _Mask__ros_msg_type = yolov8_msgs__msg__Mask;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      yolov8_msgs__msg__Point2D__Sequence__fini(&ros_message->data);
    }
    if (!yolov8_msgs__msg__Point2D__Sequence__init(&ros_message->data, size)) {
...
static uint32_t _Mask__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yolov8_msgs__msg__Mask(
...
static size_t _Mask__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_yolov8_msgs__msg__Mask(
