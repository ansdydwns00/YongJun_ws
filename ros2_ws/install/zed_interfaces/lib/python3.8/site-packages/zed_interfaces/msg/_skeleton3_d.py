...
class Skeleton3D(metaclass=Metaclass_Skeleton3D):
    ...
    _fields_and_field_types = {
        'keypoints': 'zed_interfaces/Keypoint3D[70]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['zed_interfaces', 'msg'], 'Keypoint3D'), 70),  # noqa: E501
    )
