...
bool scout_msgs__msg__scout_rc_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scout_msgs.msg._scout_rc_state.ScoutRCState", full_classname_dest, 43) == 0);
  }
  scout_msgs__msg__ScoutRCState * ros_message = _ros_message;
  {  // swa
...
{
  /* NOTE(esteve): Call constructor of ScoutRCState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("scout_msgs.msg._scout_rc_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScoutRCState");
