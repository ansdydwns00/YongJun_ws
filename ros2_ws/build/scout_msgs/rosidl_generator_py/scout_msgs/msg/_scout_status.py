...
class Metaclass_ScoutStatus(type):
    """Metaclass of message 'ScoutStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'scout_msgs.msg.ScoutStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__scout_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__scout_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__scout_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__scout_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__scout_status

            from scout_msgs.msg import ScoutActuatorState
            if ScoutActuatorState.__class__._TYPE_SUPPORT is None:
                ScoutActuatorState.__class__.__import_type_support__()

            from scout_msgs.msg import ScoutLightState
            if ScoutLightState.__class__._TYPE_SUPPORT is None:
                ScoutLightState.__class__.__import_type_support__()
    ...
    def MOTOR_ID_FRONT_RIGHT(self):
        ...
        return Metaclass_ScoutStatus.__constants['MOTOR_ID_FRONT_RIGHT']

    @property
    def MOTOR_ID_FRONT_LEFT(self):
        """Message constant 'MOTOR_ID_FRONT_LEFT'."""
        return Metaclass_ScoutStatus.__constants['MOTOR_ID_FRONT_LEFT']

    @property
    def MOTOR_ID_REAR_RIGHT(self):
        """Message constant 'MOTOR_ID_REAR_RIGHT'."""
        return Metaclass_ScoutStatus.__constants['MOTOR_ID_REAR_RIGHT']

    @property
    def MOTOR_ID_REAR_LEFT(self):
        """Message constant 'MOTOR_ID_REAR_LEFT'."""
        return Metaclass_ScoutStatus.__constants['MOTOR_ID_REAR_LEFT']

    @property
    def LIGHT_ID_FRONT(self):
        """Message constant 'LIGHT_ID_FRONT'."""
        return Metaclass_ScoutStatus.__constants['LIGHT_ID_FRONT']

    @property
    def LIGHT_ID_REAR(self):
        """Message constant 'LIGHT_ID_REAR'."""
        return Metaclass_ScoutStatus.__constants['LIGHT_ID_REAR']


class ScoutStatus(metaclass=Metaclass_ScoutStatus):
    """
    Message class 'ScoutStatus'.
    ...
    _fields_and_field_types = {
        ...
        'actuator_states': 'scout_msgs/ScoutActuatorState[4]',
        'light_control_enabled': 'boolean',
        'front_light_state': 'scout_msgs/ScoutLightState',
        'rear_light_state': 'scout_msgs/ScoutLightState',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('double'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['scout_msgs', 'msg'], 'ScoutActuatorState'), 4),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['scout_msgs', 'msg'], 'ScoutLightState'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['scout_msgs', 'msg'], 'ScoutLightState'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.actuator_states = kwargs.get(
            'actuator_states',
            [ScoutActuatorState() for x in range(4)]
        )
        self.light_control_enabled = kwargs.get('light_control_enabled', bool())
        from scout_msgs.msg import ScoutLightState
        self.front_light_state = kwargs.get('front_light_state', ScoutLightState())
        from scout_msgs.msg import ScoutLightState
        self.rear_light_state = kwargs.get('rear_light_state', ScoutLightState())
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) == 4 and
                 all(isinstance(v, ScoutActuatorState) for v in value) and
                 True), \
                "The 'actuator_states' field must be a set or sequence with length 4 and each value of type 'ScoutActuatorState'"
    ...
    def front_light_state(self, value):
        if __debug__:
            from scout_msgs.msg import ScoutLightState
            assert \
                isinstance(value, ScoutLightState), \
                "The 'front_light_state' field must be a sub message of type 'ScoutLightState'"
    ...
    def rear_light_state(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, ScoutLightState), \
                "The 'rear_light_state' field must be a sub message of type 'ScoutLightState'"
