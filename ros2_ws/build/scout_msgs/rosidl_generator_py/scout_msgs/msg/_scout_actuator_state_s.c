...
bool scout_msgs__msg__scout_actuator_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scout_msgs.msg._scout_actuator_state.ScoutActuatorState", full_classname_dest, 55) == 0);
  }
  scout_msgs__msg__ScoutActuatorState * ros_message = _ros_message;
  {  // motor_id
...
{
  /* NOTE(esteve): Call constructor of ScoutActuatorState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("scout_msgs.msg._scout_actuator_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScoutActuatorState");
