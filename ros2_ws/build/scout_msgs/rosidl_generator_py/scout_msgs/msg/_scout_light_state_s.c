...
bool scout_msgs__msg__scout_light_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("scout_msgs.msg._scout_light_state.ScoutLightState", full_classname_dest, 49) == 0);
  }
  scout_msgs__msg__ScoutLightState * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of ScoutLightState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("scout_msgs.msg._scout_light_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ScoutLightState");
