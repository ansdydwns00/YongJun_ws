...
{
  new (message_memory) zed_interfaces::msg::Skeleton3D(_init);
}

void Skeleton3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_interfaces::msg::Skeleton3D *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<zed_interfaces::msg::Keypoint3D, 70> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<zed_interfaces::msg::Keypoint3D, 70> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Skeleton3D_message_member_array[1] = {
  {
    ...
    offsetof(zed_interfaces::msg::Skeleton3D, keypoints),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Skeleton3D_message_members = {
  ...
  1,  // number of fields
  sizeof(zed_interfaces::msg::Skeleton3D),
...
{
  return &::zed_interfaces::msg::rosidl_typesupport_introspection_cpp::Skeleton3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, msg, Skeleton3D)() {
  return &::zed_interfaces::msg::rosidl_typesupport_introspection_cpp::Skeleton3D_message_type_support_handle;
}
