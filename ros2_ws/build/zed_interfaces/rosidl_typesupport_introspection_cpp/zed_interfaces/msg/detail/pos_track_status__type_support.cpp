...
{
  new (message_memory) zed_interfaces::msg::PosTrackStatus(_init);
}

void PosTrackStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<zed_interfaces::msg::PosTrackStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PosTrackStatus_message_member_array[3] = {
  {
    ...
    offsetof(zed_interfaces::msg::PosTrackStatus, odometry_status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_interfaces::msg::PosTrackStatus, spatial_memory_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(zed_interfaces::msg::PosTrackStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PosTrackStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(zed_interfaces::msg::PosTrackStatus),
...
{
  return &::zed_interfaces::msg::rosidl_typesupport_introspection_cpp::PosTrackStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, msg, PosTrackStatus)() {
  return &::zed_interfaces::msg::rosidl_typesupport_introspection_cpp::PosTrackStatus_message_type_support_handle;
}
