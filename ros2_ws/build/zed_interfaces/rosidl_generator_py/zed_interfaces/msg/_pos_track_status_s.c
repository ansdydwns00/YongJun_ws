...
bool zed_interfaces__msg__pos_track_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("zed_interfaces.msg._pos_track_status.PosTrackStatus", full_classname_dest, 51) == 0);
  }
  zed_interfaces__msg__PosTrackStatus * ros_message = _ros_message;
  {  // odometry_status
...
PyObject * zed_interfaces__msg__pos_track_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("zed_interfaces.msg._pos_track_status");
