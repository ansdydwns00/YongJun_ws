...
static const _GnssFusionStatus_type_support_symbol_names_t _GnssFusionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, msg, GnssFusionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, msg, GnssFusionStatus)),
  }
};
...
{
  return &::zed_interfaces::msg::rosidl_typesupport_cpp::GnssFusionStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_interfaces, msg, GnssFusionStatus)() {
  return get_message_type_support_handle<zed_interfaces::msg::GnssFusionStatus>();
}
