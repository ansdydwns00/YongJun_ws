...
static const _SetPose_Request_type_support_symbol_names_t _SetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, srv, SetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, srv, SetPose_Request)),
  }
};
...
{
  return &::zed_interfaces::srv::rosidl_typesupport_cpp::SetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_interfaces, srv, SetPose_Request)() {
  return get_message_type_support_handle<zed_interfaces::srv::SetPose_Request>();
}
...
static const _SetPose_Response_type_support_symbol_names_t _SetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, srv, SetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, srv, SetPose_Response)),
  }
};
...
{
  return &::zed_interfaces::srv::rosidl_typesupport_cpp::SetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_interfaces, srv, SetPose_Response)() {
  return get_message_type_support_handle<zed_interfaces::srv::SetPose_Response>();
}
...
static const _SetPose_type_support_symbol_names_t _SetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_interfaces, srv, SetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_interfaces, srv, SetPose)),
  }
};
...
{
  return &::zed_interfaces::srv::rosidl_typesupport_cpp::SetPose_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_interfaces, srv, SetPose)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<zed_interfaces::srv::SetPose>();
}
