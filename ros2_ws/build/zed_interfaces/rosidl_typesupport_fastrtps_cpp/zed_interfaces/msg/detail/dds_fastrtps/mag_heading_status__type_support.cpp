...
#include "zed_interfaces/msg/detail/mag_heading_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const zed_interfaces::msg::MagHeadingStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_interfaces::msg::MagHeadingStatus *>(
    untyped_ros_message);
...
{
  return max_serialized_size_MagHeadingStatus(full_bounded, 0);
}
...
{
  return &zed_interfaces::msg::typesupport_fastrtps_cpp::_MagHeadingStatus__handle;
}
