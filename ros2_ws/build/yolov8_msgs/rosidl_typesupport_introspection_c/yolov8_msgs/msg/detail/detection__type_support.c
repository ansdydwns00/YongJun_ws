...
static rosidl_typesupport_introspection_c__MessageMember Detection__rosidl_typesupport_introspection_c__Detection_message_member_array[10] = {
  {
    "class_id",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yolov8_msgs, msg, Detection)() {
  ...
  Detection__rosidl_typesupport_introspection_c__Detection_message_member_array[9].members_ =
